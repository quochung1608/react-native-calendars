...
const Calendar = (props) => {
    ...
    const renderDay = (day, id) => {
        ...
        <Day {...dayProps} id={id} date={toMarkingFormat(day)} state={getState(day, currentMonth, props)} marking={markedDates?.[toMarkingFormat(day)]} onPress={onPressDay} onLongPress={onLongPressDay}/>
      </View>);
    };
